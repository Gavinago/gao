...
public class Room implements Serializable{
	...
	public String toString() {
		return "Room [roomid=" + roomid + ", roomsnum=" + roomsnum + ", roomstate=" + roomstate + ", roomprice="
				+ roomprice + ", roomvip=" + roomvip + ", roomclass=" + roomclass + ", roomname=" + roomname
				+ ", roomfirmprice=" + roomfirmprice + ", roomcash=" + roomcash + "]";
	}
