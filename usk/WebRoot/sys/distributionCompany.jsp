...
<%@include file="../common/common.jsp" %>
  ...
  <body>
    ...
    <form:form action="saveOrgUserRelation.do" method="post"  commandName="pu" id="mailForm" target="mailiframe">
			...
			name="orgid" id="orgid"
			data-options="
					url:'viewCompanyJson.do?id=${pu.id}&type=1',
					method:'get',
					valueField:'id',
					textField:'text',
					panelHeight:'auto'
