  ...
  <body>
    ...
    <div id="dd" class="easyui-draggable easyui-resizable" data-options="handle:'#mysysform'" style="width:500px;height:280px;border:1px solid #ccc">
        ...
        <div style="padding:10px 0 10px 60px">
         ...
         <form:form action="addEm.do" method="post"  commandName="em" id="sysForm" target="mailiframe">
            <table>
                <tr>
                    <td>费用类别:</td>
                  
                    <td>
                    <input class="easyui-validatebox" type="text" name="expensename" data-options="required:true">
                    </td>
                </tr>
                <tr>
                    <td>价格:</td>
                    ...
                    <td>
                    <input class="easyui-numberbox" name="price" data-options="required:true,min:0,precision:2">
                    (元)
                    </td>
                </tr>
                 <tr>
