...
<%@include file="../../common/common.jsp" %>
  ...
  <body>
    ...
    <form:form action="distributionFrontCompany.do" method="post"  commandName="pu" id="mailForm" target="mailiframe">
			...
			name="orgid" id="orgid"
			data-options="
					url:'viewFrontUserCompanyJson.do?id=${pu.id}&type=0',
					method:'get',
					valueField:'id',
					textField:'text',
					panelHeight:'auto'
       ...
       <script type="text/javascript">
		...
		function getChecked(){
			...
			//alert(menuid);
 			...
 			$.ajax({
url: 'distributionFrontCompany.do',
type: 'POST',
data:{userid:$('#id').val(),orgid:$('#orgid').combobox('getValue')},
dataType: 'text',
timeout: 10000,
