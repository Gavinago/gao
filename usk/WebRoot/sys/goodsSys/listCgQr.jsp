...
<body style="visibility: visible;">
	...
	<div id="tb" style="padding:5px;height:auto">
		<div style="margin-bottom:5px">
			<a href="javascript:void(0)" class="easyui-linkbutton"
				iconCls="icon-add" plain="true" id="yfkbtn">预付款操作</a>
			<!--  
	...
	<table id="tt" class="easyui-datagrid" style="width:auto;height:320px"
		data-options="fit:true,collapsible:true,rownumbers:true,url:'cgglfk.do',fitColumns:false,singleSelect:false,sortOrder:'desc',sortName:'vmname',pagination:true,toolbar:'#tb'"
		title="采购管理">
		<thead>
			<tr>
...
$(listId).datagrid('reload');
    ...
    var toolbar = [{
       ...
       //editPanel('eidtGoods.do?id='+parkparams,'修改货物信息_'+parkparams);
			$.messager.prompt('预付款操作', '金额（元）', function(r){
				if (r){
					//alert('you type: '+r);
					
$.ajax({url: 'slaesYfk.do', 
type: 'POST', 
