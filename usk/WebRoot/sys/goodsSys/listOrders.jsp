...
<!--  
        <a href="javascript:void(0)" class="easyui-linkbutton"  iconCls="icon-add" plain="true" id="addbtn">确认付款</a>  
        &nbsp; &nbsp;
        ...
        &nbsp; &nbsp;
          ...
          &nbsp; &nbsp;
       -->   <!--  -->
       <shiro:hasPermission name="/deleteOrders.do"> 
   ...
   <form:form action="" method="post" id="searchForm">
    ...
    <table id="tt" class="easyui-datagrid" style="width:1200px;height:320px"
            data-options="fit:true,collapsible:true,rownumbers:true,url:'orderedInfos.do',fitColumns:false,singleSelect:false,sortOrder:'desc',sortName:'vmname',pagination:true,toolbar:'#tb'"
            title="数据加载列表" 
           >
        <thead>
 ...
 <th  data-options="field:'ordernum'">订单号</th>
                ...
                <th  data-options="field:'addedprice'">价格</th>
                    ...
                    <th  data-options="field:'pdfpath',formatter:  rowformater">销售合同预览</th>
                    <th  data-options="field:'status',formatter:  confirmpayment">确认付款操作</th>
                ...
                <th data-options="field:'owstatus',formatter:function(value){
                    if(value=='0'){
                        return '未打印';
                    }else if(value=='1'){
                        return '已打印';
                ...
                <th data-options="field:'iskfp',formatter:function(value){
                    if(value=='0'){
                        return '未开具';
                    }else if(value=='1'){
                        return '已开具';
	   ...
	   var parks = [];
            if(rows == 0){
                ...
                return;
                  ...
                  var parkparams = parks.join(',');
					delDatas(parkparams,'#tt','deleteOrders.do');
			}
        	 });
