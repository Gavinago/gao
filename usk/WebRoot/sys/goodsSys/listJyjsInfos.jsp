...
<body style="visibility: visible;">
  ...
  订单号:   
	...
	<table id="tt" class="easyui-datagrid" style="width:auto;height:320px"
		data-options="fit:true,collapsible:true,rownumbers:true,url:'jyjsxx.do',fitColumns:false,singleSelect:false,sortOrder:'desc',sortName:'vmname',pagination:true,toolbar:'#tb'"
		title="销售发票">
		<thead>
			<tr>
...
<th data-options="field:'pdfpath',width:$(this).width()*0.1,formatter:  owpdfpathformater">出库单预览</th>
<th data-options="field:'isjyjs',width:$(this).width()*0.1,formatter:function(value){
                    if(value=='0'){
                        return '否';
                    }else if(value=='1'){
                        return '是';
                ...
                <th data-options="field:'iskfp',width:$(this).width()*0.1,formatter:function(value){
                    if(value=='0'){
                        return '否';
                    }else if(value=='1'){
                        return '是';
