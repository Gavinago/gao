...
return "<a href='<%=basePath%>"+row.pdfpath+"' target='_blank'>查看</a>";
 ...
 function scpdfpathformater(value,row,index)
{
//alert(row.pdfpath);
	...
	<div id="tb" style="padding:5px;height:auto">
       ...
       -->
			...
			<a
				...
				iconCls="icon-add" plain="true" id="confirmXsfpbtn">销售发票开具确认</a>
	...
	<table id="tt" class="easyui-datagrid" style="width:auto;height:320px"
		...
		<thead>
			<tr>
                ...
                <th data-options="field:'fpmoney'">发票金额(元)</th>
...
<th data-options="field:'vmname'">名称</th>
				...
				<!--<th data-options="field:'blstatus',width:$(this).width()*0.1,formatter:function(value){
                    if(value=='0'){
                        return '未打印';
                    }else if(value=='1'){
                        return '已打印';
...
<th data-options="field:'scpdfpath',formatter:  scpdfpathformater">销售合同预览</th>
