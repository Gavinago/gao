...
<body style="visibility: visible;">
	...
	<table id="tt" class="easyui-datagrid" style="width:auto;height:320px"
		data-options="fit:true,collapsible:true,rownumbers:true,url:'printDelivery.do',fitColumns:false,singleSelect:false,sortOrder:'desc',sortName:'vmname',pagination:true,toolbar:'#tb'"
		title="采购管理">
		<thead>
			<tr>
...
<th data-options="field:'ordernum'">订单号</th>
				...
				<th data-options="field:'ordertime',width:$(this).width()*0.15">下单时间</th>
				<th data-options="field:'buyaccout',width:$(this).width()*0.1">客户帐号</th>
				<!--  <th
					data-options="field:'pdfpath',width:$(this).width()*0.2,formatter:  rowformater">采购合同预览</th>-->
					<th
					data-options="field:'pdfpath',width:$(this).width()*0.1,formatter:  rowformater">销售合同预览</th>
<!-- <th
					data-options="field:'blpdfpath',width:$(this).width()*0.2,formatter:  blpdfrowformater">提单预览</th>
					
				<th data-options="field:'blstatus',width:$(this).width()*0.2,formatter:function(value){
                    if(value=='0'){
                        return '未打印';
                    }else if(value=='1'){
                        return '已打印';
...
<th data-options="field:'owstatus',width:$(this).width()*0.1,formatter:function(value){
                    if(value=='0'){
                        return '未打印';
                    }else if(value=='1'){
                        return '已打印';
