...
<body style="visibility: visible;">
	...
	<div id="tb" style="padding:5px;height:auto">
       ...
       -->
			...
			<a
				...
				iconCls="icon-add" plain="true" id="confirmJyjsbtn">完成交易结算确认</a>
  ...
  订单号:   
	...
	<table id="tt" class="easyui-datagrid" style="width:auto;height:320px"
		data-options="fit:true,collapsible:true,rownumbers:true,url:'jyjs.do',fitColumns:false,singleSelect:false,sortOrder:'desc',sortName:'vmname',pagination:true,toolbar:'#tb'"
		title="采购管理">
		<thead>
			<tr>
				<th data-options="field:'purid',checkbox:true"></th>
				<th data-options="field:'id'">编号</th>
					  <th data-options="field:'isjyjs',formatter:function(value){
                    if(value=='0'){
                        return '否';
                    }else if(value=='1'){
                        return '是';
                ...
                <th data-options="field:'account'">结算操作人员</th>
<th data-options="field:'vmname'">品名</th>
 <th data-options="field:'ordernum'">订单号</th>
				  <th data-options="field:'goodsnum'">货号</th>
			<th data-options="field:'cjje'">成交金额</th>
			<th data-options="field:'jsje'">结算金额</th>
				  <th data-options="field:'addedweight'">合同重量</th>
				<th data-options="field:'realweight'">出库重量</th>
				<th data-options="field:'addedprice'">单价</th>
				<th data-options="field:'htje'">合同金额</th>
				<th data-options="field:'amountdiff'">金额差</th>
				
				<th data-options="field:'gbf'">过磅费</th>
				<th data-options="field:'onfares'">上车费</th>	
				<th data-options="field:'companyname'">公司名</th>
				<th data-options="field:'contacttsname'">提货人</th>
				<th data-options="field:'createtime'">时间</th>
				<th data-options="field:'scpdfpath',formatter:  scpdfpathrowformater">销售合同预览</th>
				<!-- <th data-options="field:'blpdfpath',formatter:  blpdfrowformater">提货单预览</th>
				 <th data-options="field:'status',width:$(this).width()*0.2,formatter:function(value){
                    if(value=='0'){
                        return '未打印';
                    }else if(value=='1'){
                        return '已打印';
...
<th data-options="field:'pdfpath',formatter:  owpdfpathformater">出库单预览</th>
	   ...
	   var parks = [];
            if(rows == 0){
                ...
                return;
                  ...
                  var parkparams = parks.join(',');
					okDatas(parkparams,'#tt','confirmSalesJyjsOK.do');
			}
        	 });
