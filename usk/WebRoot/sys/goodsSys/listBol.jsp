...
<body style="visibility: visible;">
	...
	<div id="tb" style="padding:5px;height:auto">
		<div style="margin-bottom:5px">
			<a href="javascript:void(0)" class="easyui-linkbutton"
				iconCls="icon-add" plain="true" id="printBolbtn">打印提单</a> 
			<!--  
	...
	<table id="tt" class="easyui-datagrid" style="width:auto;height:320px"
		data-options="fit:true,collapsible:true,rownumbers:true,url:'bollist.do',fitColumns:false,singleSelect:false,sortOrder:'desc',sortName:'vmname',pagination:true,toolbar:'#tb'"
		title="采购管理">
		<thead>
			<tr>
...
<th data-options="field:'ordernum'">订单号</th>
				...
				<th
					data-options="field:'pdfpath',width:$(this).width()*0.1,formatter:  rowformater">提单预览</th>
    ...
    var toolbar = [{
        ...
        $(function (){
       	...
       	$('#dlg').dialog('close');
        	 ...
        	 if(f){
        	 $('#tt').datagrid('load', { "vmid": $('#vmid').combobox('getValue')});
        	 }else{
       ...
       editPanel('printBol.do?orderid='+parkparams,'打印提单'+parkparams);
