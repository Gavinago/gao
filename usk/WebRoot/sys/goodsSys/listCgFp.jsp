...
<body style="visibility: visible;">
	...
	<div id="tb" style="padding:5px;height:auto">
		<div style="margin-bottom:5px">
			<a href="javascript:void(0)" class="easyui-linkbutton"
				iconCls="icon-add" plain="true" id="kjcgfpbtn">是否收到发票</a>
			<!--  
	...
	<table id="tt" class="easyui-datagrid" style="width:auto;height:320px"
		data-options="fit:true,collapsible:true,rownumbers:true,url:'cgglfp.do',fitColumns:false,singleSelect:false,sortOrder:'desc',sortName:'vmname',pagination:true,toolbar:'#tb'"
		title="采购管理">
		<thead>
			<tr>
				...
				<th data-options="field:'fkje'">预付款</th>
				  <!-- <th data-options="field:'zj'">总价</th> -->
				   <th data-options="field:'jsje'">结算金额</th>
				    <th data-options="field:'fpje'">发票金额</th>
				...
				<th
					data-options="field:'pdfpath',width:$(this).width()*0.1,formatter:  rowformater">采购合同预览</th>

				<th
					data-options="field:'pstatus',width:$(this).width()*0.1,formatter:function(value){
                    if(value=='0'){
                        return '未签订';
                    }else if(value=='1'){
                        return '签订中';
...
<th
             ...
             <!--    <th data-options="field:'fkstatus',width:$(this).width()*0.2,formatter:function(value){
                    if(value=='0'){
                        return '未付款';
                    }else if(value=='1'){
                        return '预付款';
                ...
                <th data-options="field:'fkje'">付款金额</th>-->
