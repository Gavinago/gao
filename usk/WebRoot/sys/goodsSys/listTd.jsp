...
return "<a href='<%=basePath%>"+row.owpdfpath+"' target='_blank'>查看</a>";
   ...
   function tdpdfformater(value,row,index)
{
//alert(row.tdpdf);
if(row.tdpdf==''||(typeof(row.tdpdf) == "undefined")){
return "未打印";
}else{
return "<a href='<%=basePath%>"+row.tdpdf+"' target='_blank'>查看</a>";
}
...
<body style="visibility: visible;">
	...
	<div id="tb" style="padding:5px;height:auto">
		<div style="margin-bottom:5px">
			<a href="javascript:void(0)" class="easyui-linkbutton"
				iconCls="icon-add" plain="true" id="printDeliverbtn">打印提单</a> 
		<!--
        &nbsp; &nbsp;
      ...
      <!--   订单号:      <input class="easyui-combobox" style="width:300px;" name="vmid"
				id="vmid"
				data-options="
					url:'viewPzJson.do',
					method:'get',
	...
	<table id="tt" class="easyui-datagrid" style="width:auto;height:320px"
		data-options="fit:true,collapsible:true,rownumbers:true,url:'tdlist.do',fitColumns:false,singleSelect:false,sortOrder:'desc',sortName:'vmname',pagination:true,toolbar:'#tb'"
		title="采购管理">
		<thead>
			<tr>
				<th data-options="field:'purid',checkbox:true"></th>
				<th data-options="field:'owid'">编号</th>

<th data-options="field:'buyerCompanyName'">提货单位</th>
<th data-options="field:'hw'">存放货位</th>
<th data-options="field:'xh'">原存货箱号</th>
<th data-options="field:'ch'">原存货车号</th>
<th data-options="field:'salesnum'">销售合同编号</th>
<th data-options="field:'owclUserName'">业务受理员</th>

<th data-options="field:'sellerCompanyName'">存货单位</th>
<th data-options="field:'realweight'">出仓重量</th>
<th data-options="field:'cksj'">提货日期</th>
<th data-options="field:'ckxh'">提货箱号</th>
<th data-options="field:'trucknum'">提货车号</th>
<th data-options="field:'cksj'">出单日期</th>
				<th data-options="field:'vmname'">货物名称</th>
				<th data-options="field:'goodsnum'">仓单编号</th>
				<th data-options="field:'weight'">进仓重量(吨)</th>
...
<th data-options="field:'tdpdf',formatter:  tdpdfformater">提单预览</th>
			</tr>
		</thead>
	</table>
            ...
            if(rows == 0){
              ...
              $.messager.alert("系统提示","一次只能打印一条数据!","info");
                return;
                  ...
                  for(var i=0;i<rows.length;i++){
                      parks.push(rows[i].owid);
                  }
                  var parkparams = parks.join(',');
                
       editPanel('printTd.do?owid='+parkparams,'打印提单'+parkparams);
