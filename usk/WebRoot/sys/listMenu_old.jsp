...
<div style="margin-bottom:5px">  
   ...
   <form:form action="" method="post" id="searchForm">
    ...
    <table id="tt" class="easyui-datagrid" style="width:480px;height:320px"
            data-options="fit:true,collapsible:true,rownumbers:true,url:'viewAllMenuJson.do',fitColumns:true,singleSelect:false,sortOrder:'desc',sortName:'clintname',pagination:true,toolbar:'#tb'"
        ...
        <thead>
            <tr>
                ...
                <th data-options="field:'name',width:$(this).width()*0.2">名称</th>
                <th  data-options="field:'menupid',width:$(this).width()*0.2">父菜单编号</th>
                <th align="center" data-options="field:'description',width:$(this).width()*0.2">描述</th>
                <th  align="center" data-options="field:'pageurl',width:$(this).width()*0.2">地址</th>
                <th  align="center" data-options="field:'type',width:$(this).width()*0.2,formatter:function(value){
                    if(value=='0'){
                        return '功能按钮';
                    }else if(value=='1'){
                        return '导航菜单';
