...
.A4 { margin: 0 auto;width: 680px;}
.f_12{ font-size:12px;}
.f_red{ color:#F00}
.t_tab td{ padding-left:10px;}
.table_block{border:solid 0px #000000; padding:6px 0px;width:680px}
</style>
</head>
<body>
...
（<span class="f_red">含17%发票，不含2.5‰手续费</span>）</td>
    <td align="center" bgcolor="#FFFFFF">${cpm.addedprice*cpm.realweight}</td>
    <td rowspan="3" align="center" bgcolor="#FFFFFF">${jhsj}日前提货</td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="30">十、合同有效期：<u>${htyxq1 }</u>日至<u>${htyxq2}</u>日</td>
  </tr>
  <tr>
    <td height="30">十一、其它约定：
    <table width="680" border="0" cellspacing="0" cellpadding="0" bgcolor="#666666" class="t_tab" style="table-layout:fixed; word-break:break-strict;">
  <tr>
  ...
  <tr>
    ...
    <table width="670" border="0" cellspacing="0" cellpadding="0" bgcolor="#666666" class="t_tab" style="table-layout:fixed; word-break:break-strict;">
  <tr>
    <td width="335" height="24" bgcolor="#FFFFFF">甲  方</td>
    <td width="335" height="24" bgcolor="#FFFFFF">乙  方</td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="24" bgcolor="#FFFFFF">开户银行及帐号：${cpm.bank} </td>
    <td height="24" bgcolor="#FFFFFF">开户银行及帐号：${buyerbank}</td>
  </tr>
  <tr>
