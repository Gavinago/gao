...
<div style="margin-bottom:5px">  
   ...
   <form:form action="" method="post" id="searchForm">
    ...
    <table id="tt" class="easyui-datagrid" style="width:auto;height:320px"
            data-options="fit:true,collapsible:true,rownumbers:true,url:'viewAllOrgContactsJson.do',fitColumns:false,singleSelect:false,sortOrder:'desc',sortName:'clintname',pagination:true,toolbar:'#tb'"
            title="数据加载列表"
           >
        <thead>
            <tr>
   ...
   <th  data-options="field:'remark',width:$(this).width()*0.1">备注</th>
        ...
        $(function (){
        	...
        	//$('#tt').datagrid('reload',{pageindex:11});
        	 $("#addbtn").click(function () {
        			addPanel('addSysUserOrgContacts.do','新增系统帐号公司联系人');
        	 }); 
