...
<div style="margin-bottom:5px">  
   ...
   <form:form action="" method="post" id="searchForm">
    ...
    <table id="tt" class="easyui-datagrid" style="width:480px;height:320px"
            data-options="fit:true,collapsible:true,rownumbers:true,url:'viewAllVMJson.do',fitColumns:true,singleSelect:false,sortOrder:'desc',sortName:'clintname',pagination:true,toolbar:'#tb'"
            title="数据加载列表" 
           >
        <thead>
            <tr>
                ...
                <th  data-options="field:'name',width:$(this).width()*0.2">品种名称</th>
  <th  data-options="field:'createusername',width:$(this).width()*0.2">创建人</th>
...
$(listId).datagrid('reload');
    ...
    var toolbar = [{
       ...
       editPanel('eidtVm.do?id='+parkparams,'修改品种_'+parkparams);
	   ...
	   var parks = [];
            if(rows == 0){
                ...
                return;
                  ...
                  var parkparams = parks.join(',');
					delDatas(parkparams,'#tt','deleteVm.do');
			}
        	 });
