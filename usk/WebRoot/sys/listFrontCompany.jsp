...
<div style="margin-bottom:5px">  
   ...
   <form:form action="" method="post" id="searchForm">
    ...
    <table id="tt" class="easyui-datagrid" style="width:480px;height:320px"
            data-options="fit:true,collapsible:true,rownumbers:true,url:'viewAllFrontCompanyJson.do',fitColumns:true,singleSelect:false,sortOrder:'desc',sortName:'clintname',pagination:true,toolbar:'#tb'"
            title="数据加载列表" 
           >
        <thead>
            <tr>
                ...
                <th  data-options="field:'name',width:$(this).width()*0.3">公司名称</th>
   <th  data-options="field:'legalrep',width:$(this).width()*0.1">法定代表人</th>
      <th data-options="field:'nob',width:$(this).width()*0.1,formatter:function(value){
                    if(value=='0'){
                        return '企业单位';
                    }else if(value=='1'){
                        return '事业单位';
                 ...
                 <th data-options="field:'type',width:$(this).width()*0.1,formatter:function(value){
                    if(value=='0'){
                        return '会员公司';
                    }else if(value=='1'){
                        return '系统公司';
      ...
      <th  data-options="field:'bank',width:$(this).width()*0.1">开户银行</th>
       <th  data-options="field:'zipcode',width:$(this).width()*0.1">邮编</th>
                <th align="center" data-options="field:'createtime',width:$(this).width()*0.15">创建时间
                </th>
            </tr>
        </thead>
    </table>
        ...
        $(function (){
        	...
        	//$('#tt').datagrid('reload',{pageindex:11});
        	 $("#addbtn").click(function () {
        			addPanel('addFrontCompany.do','新增会员公司');
        	 }); 
