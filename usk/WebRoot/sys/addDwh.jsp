  ...
  <body>
    ...
    <div id="dd" class="easyui-draggable easyui-resizable" data-options="handle:'#mysysform'" style="width:500px;height:280px;border:1px solid #ccc">
        ...
        <div style="padding:10px 0 10px 60px">
         ...
         <form:form action="addDwh.do" method="post"  commandName="dwh" id="sysForm" target="mailiframe">
            <table>
                <tr>
                    <td>仓库地址:</td>
                  
                    <td>
                    <input style="width:300px" class="easyui-validatebox" type="text" name="name" data-options="required:true">
                    </td>
                </tr>
