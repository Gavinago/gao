...
<%@include file="../common/common.jsp" %>
  ...
  <body>
    ...
    <form:form action="saveUserContactsRelation.do" method="post"  commandName="pu" id="mailForm" target="mailiframe">
			...
			data-options="
					url:'viewUserContactsJson.do?id=${pu.id}&type=1',
					method:'get',
					valueField:'id',
					textField:'text',
					panelHeight:'auto',
       ...
       <script type="text/javascript">
		...
		function getChecked(){
			...
			//alert(menuid);
 			...
 			$.ajax({
url: 'saveUserContactsRelation.do',
type: 'POST',
data:{userid:$('#id').val(),contactsid:$('#contactsid').combobox('getValue')},
dataType: 'text',
timeout: 10000,
