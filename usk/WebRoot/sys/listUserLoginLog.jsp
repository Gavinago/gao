...
<div style="margin-bottom:5px">  
   ...
   <form:form action="" method="post" id="searchForm">
    ...
    <table id="tt" class="easyui-datagrid" style="width:480px;height:320px"
            data-options="fit:true,collapsible:true,rownumbers:true,url:'userloginlog.do',fitColumns:true,singleSelect:false,sortOrder:'desc',sortName:'clintname',pagination:true,toolbar:'#tb'"
        ...
        <thead>
            <tr>
                ...
                <th  data-options="field:'useraccount',width:$(this).width()*0.2">账号</th>
  <th  data-options="field:'ip',width:$(this).width()*0.2">ip</th>
