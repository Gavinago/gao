...
<div style="margin-bottom:5px">  
   ...
   <form:form action="" method="post" id="searchForm">
       客户名称:   
        <input class="easyui-validatebox" type="text" id="clintname" name="clintname" data-options="">
    ...
    <table id="tt" class="easyui-datagrid" style="width:480px;height:320px"
            data-options="fit:true,collapsible:true,rownumbers:true,url:'viewAllMailClientJson.do',fitColumns:true,singleSelect:false,sortOrder:'desc',sortName:'clintname',pagination:true,toolbar:'#tb'"
        ...
        <thead>
            <tr>
           		...
           		<th field="id" >编号</th>
                <th field="clintname" data-options="width:$(this).width()*0.2">客户名称</th>
                <th field="clientaddress" data-options="width:$(this).width()*0.2">客户地址</th>
                <th field="clinttel"  align="center" data-options="width:$(this).width()*0.2">客户电话</th>
...
$(listId).datagrid('reload');
    ...
    var toolbar = [{
        ...
        $(function (){
        	 ...
        	 if(f){
        	 $('#tt').datagrid('load', { "clintname":  $('#clintname').val()});
        	 }else{
       ...
       editPanel('eidtMC.do?id='+parkparams,'修改客户_'+parkparams);
	   ...
	   var parks = [];
            if(rows == 0){
                ...
                return;
                  ...
                  var parkparams = parks.join(',');
					delDatas(parkparams,'#tt','deleteMC.do');
			}
        	 });
