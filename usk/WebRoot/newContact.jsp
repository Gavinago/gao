...
<table  bgcolor="lightblue" width="350" height="500" align="center" style="border-collapse: collapse;" border="1" bordercolor="#006699" >
    <tr>
        <td align="center"><h3>注册</h3></td>
    </tr>
    <tr valign="top" align="center">
    <td align="center">
         <form:form action="saveContact.do" method="post" commandName="newContact" id="mainForm">
                <table width="500" style="border-collapse: collapse;" border="0" bordercolor="#006699" cellspacing="2" cellpadding="2">    
                    ...
                    <tr>
                        <td width="100" align="right">RePassword</td>
                        <td width="150">
                        <input type="password" name="repassword" id="repassword" onblur="checkRepassword()" style="width:150; height:20"/></td>
                        <td align="left">
                        <span style="color:red" id="repassword1"></span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <input type="button"  value="Back" onclick="javascript:go('login.do');">
                        </td>
                    </tr>                    
                </table>            
        </form:form>
