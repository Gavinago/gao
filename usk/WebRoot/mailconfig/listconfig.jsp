...
<div id="tb" style="padding:5px;height:auto"> 
   ...
   &nbsp;
    ...
    <table id="tt" class="easyui-datagrid" style="width:520px;height:320px"
            data-options="remoteSort:true,sortName:'domainDayuse',sortOrder:'desc',fit:true,collapsible:true,rownumbers:true,url:'viewAllIndividuationconfigJson.do',fitColumns:true,singleSelect:false,pagination:true,toolbar:'#tb'"
        ...
        <thead>
            <tr>
                ...
                <th field="id" >编号</th>
                <th field="configkey" data-options="">配置名称</th>
                <th field="configvalue"  align="center">配置值</th>
                <th field="description"  align="center">配置描述</th>
...
$(listId).datagrid('reload');
    ...
    var toolbar = [{
       ...
       editPanel('eidtIc.do?id='+parkparams,'修改配置_'+parkparams);
	   ...
	   var parks = [];
           ...
           //  $.messager.alert("系统提示","为了慎重起见一次只能删除一条数据!","info");
             //   return;
				...
				//if (r){
					delDatas(parkparams,'#tt','deleteIc.do');
				//}
			//});
			}
        	 });
