...
//import com.capinfo.multilingual.tool.FileDown;
...
public class CreateHTMLByUrl {
	...
	public static void main(String[] args) throws Exception {
		String httpUrl = "http://localhost:8080/WsSys/pmtempView.do?orderid=16&htbh=PM138976982384512793856&htsj=2014-1-15&jhsj=2014-1-15&htyxq1=2014-1-15&htyxq2=2014-2-15";
		 writeHtml(httpUrl, "e:/test/test.html", true);
//		URL url = new java.net.URL(httpUrl);
